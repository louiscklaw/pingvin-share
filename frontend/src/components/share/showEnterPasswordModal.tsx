...
const showEnterPasswordModal = (modals: ModalsContextProps, submitCallback: (password: string) => Promise<void>) => {
...
const Body = ({ submitCallback }: { submitCallback: (password: string) => Promise<void> }) => {
