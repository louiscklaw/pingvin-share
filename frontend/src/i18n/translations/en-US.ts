export default {
  ...
  'upload.modal.completed.explain-link': 'You can share the file(s) using link above, Thanks.',
  ...
  'upload.explain':
    'You are going to share files,please click "start share" to confirm 😊. If you want to attach message, please jod it down below.',
  'Go-Upload': 'go upload',
  'how-to-use': 'how to use ?',
  'louislabs-file-sharing': 'Louislabs file sharing',
};
