export default {
  ...
  "common.text.carousell_share_link": "可用於 carousell 的連結",
  "upload.modal.completed.explain-link":
    "🎉攪掂! 檔案已經準備好，請將以上連結 SEND 番比 louis 🙏🙇‍♀️",
  "upload.explain":
    "您即將分享檔案，請點擊「開始分享」以確認 😊。如果您想附上訊息，請在下方填寫。",
  // customized
  "Go-Upload": "上傳檔案",
  "how-to-use": "點用啊 ?",
  "louislabs-file-sharing": "Louislabs 文件共享",
};