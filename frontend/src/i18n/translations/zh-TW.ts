export default {
  ...
  'upload.modal.accordion.name-and-description.title': '名稱 / 說明',
  ...
  'upload.modal.completed.explain-link': '您可以透過上方的連結分享檔案，謝謝。',
  // END /upload
  // /share/[id]
  ...
  'upload.modal.completed.share-ready': '🎉攪掂! 檔案已經準備好',
  'upload.explain': '您即將分享檔案，請點擊「開始分享」以確認 😊。如果您想附上訊息，請在下方填寫。',
  'Go-Upload': '上傳檔案',
  'how-to-use': '如何使用 ?',
