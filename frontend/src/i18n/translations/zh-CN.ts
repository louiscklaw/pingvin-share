export default {
  ...
  'account.reverseShares.modal.public-access.description':
    '公开使用此预留共享创建的共享。如果禁用，则只有您和共享创建者才能查看。',
  ...
  'admin.config.email.enable-share-email-recipients.description':
    '是否允许与收件人分享电子邮件。只有在SMTP被激活时才启用此功能。',
  ...
  'upload.modal.completed.explain-link': '您可以通过上方的链接分享文件，谢谢。',
