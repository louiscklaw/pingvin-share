import { Center, Col, createStyles, Grid, Paper, Stack, Text, Title } from '@mantine/core';
        ...
        if (isNewReleaseAvailable) {
          setManagementOptions([
            ...managementOptions,
            {
              title: 'Update',
              icon: TbRefresh,
              route: 'https://github.com/stonith404/pingvin-share/releases/latest',
            },
          ]);
        }
      })
            ...
            {managementOptions.map((item) => {
              return (
                <Col xs={6} key={item.route}>
                  <Paper withBorder component={Link} href={item.route} key={item.title} className={classes.item}>
