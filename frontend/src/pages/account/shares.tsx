import { ActionIcon, Box, Button, Center, Group, Space, Stack, Table, Text, Title } from '@mantine/core';
                  ...
                  <td>
                    <Group spacing="xs">
                      ...
                      {share.security.passwordProtected && (
                        <TbLock color="orange" title={t('account.shares.table.password-protected')} />
                      )}
                    </Group>
                  </td>
                  <td>{share.name}</td>
                  ...
                  <td>
                    <Group position="right">
                      ...
                      <ActionIcon
                        ...
                        size={25}
                        onClick={() => {
                          showShareInformationsModal(modals, share, parseInt(config.get('share.maxSize')));
                        }}
                      >
                        <TbInfoCircle />
                      </ActionIcon>
