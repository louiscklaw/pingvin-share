  ...
  const openModal = () =>
    modals.openConfirmModal({
      ...
      children: (
        <>
          <Text size="sm">
            This is a easy file sharing between you and louis.
          </Text>

          <Text size="sm">
            Just click "Go Upload", You will be redirect to the upload page.
            Select the file(s) you want to share, and then tap "Upload"
          </Text>

          <Text size="sm">
            A dialogue prompted for confirmation, Tap "Upload" if you sure and
            anywhere else to cancel. In case you want to leave notes along with
            your upload. Tap "Want to leave notes?" and fill it in.
          </Text>

          <Text size="sm">
            After upload complete, A dialogue with shareable link shown. If you
            want to share me the link through carousell chat, you can copy the
            link "(for carousell)" and paste it in the chat. Copy the link
            (normal share) for any other chat program. Click "Done" when you
            complete : )
          </Text>
